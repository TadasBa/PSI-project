...
namespace Pantry.Tests
{
    public class ModelsTests_Product
    {
        ...
        {
            Product product1 = new Product("bread", ProductType.BAKED_GOODS, new DateTime(year1, month1, day1));
            Product product2 = new Product("bread", ProductType.BAKED_GOODS, new DateTime(year2, month2, day2));
